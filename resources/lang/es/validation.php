...
return [
        ...
        "min.string"=> "El :Attribute debe contener al menos :min caracteres.",
        ...
        "password.uncompromised"=> "La contraseña proporcionada se ha visto comprometida en una filtración de datos (data leak). Elija una :attribute diferente.",
